...
class TestInstructorDashboard(ModuleStoreTestCase, LoginEnrollmentTestCase, XssTestMixin):
    ...
    def test_membership_reason_field_visibility(self, enbale_reason_field):
        ...
        reason_field = '<textarea rows="2" id="reason-field-id" name="reason-field" placeholder="Reason" spellcheck="false"></textarea>'
    ...
    def test_dashboard_analytics_points_at_insights(self):
        ...
        response = self.client.get(self.url)
        # pylint: disable=line-too-long
        analytics_section = '<li class="nav-item"><button type="button" class="btn-link instructor_analytics" data-section="instructor_analytics">Analytics</button></li>'
